...
create_sfx_windows gcc73-rpi3-canadian-cross "$HOME/x-tools/HOST-x86_64-w64-mingw32/armv8-rpi3-linux-gnueabihf"
create_sfx_windows gcc73-imx7-canadian-cross "$HOME/x-tools/HOST-x86_64-w64-mingw32/armv7-imx7-linux-gnueabihf"
